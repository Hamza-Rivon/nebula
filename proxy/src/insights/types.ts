// Shared schema between the analyze pipeline and the frontend. Field names are
// load-bearing — renaming will break the UI. Mirrors dashboard/src/types.ts so
// the proxy module is self-contained.
